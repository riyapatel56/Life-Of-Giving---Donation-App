...
import 'package:life_of_giving/NGO/Blood/B-/B-1.dart';
import 'package:life_of_giving/NGO/Blood/B-/b-2.dart';
import 'package:life_of_giving/NGO/Blood/B-/b-3.dart';
import 'package:life_of_giving/NGO/Blood/B-/b-4.dart';
import 'package:life_of_giving/categorycardpages/blood.dart';

class BNegative extends StatefulWidget {
  @override
  _BNegativeState createState() => _BNegativeState();
}
...
class _BNegativeState extends State<BNegative> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'NGO\'s which are donating B- Blood',
          ...
          child: Column(
            children: [
              InkResponse(
                onTap: () {
                  Navigator.push(
                      context, MaterialPageRoute(builder: (context) => BNB1()));
                },
                child: Card(
              ...
              InkResponse(
                onTap: () {
                  Navigator.push(
                      context, MaterialPageRoute(builder: (context) => BNB2()));
                },
                child: Card(
                  margin: const EdgeInsets.symmetric(
                      vertical: 20, horizontal: 15.0),
              ...
              InkResponse(
                onTap: () {
                  Navigator.push(
                      context, MaterialPageRoute(builder: (context) => BNB3()));
                },
                child: Card(
                  margin: const EdgeInsets.symmetric(
                      vertical: 20, horizontal: 15.0),
              ...
              InkResponse(
                onTap: () {
                  Navigator.push(
                      context, MaterialPageRoute(builder: (context) => BNB4()));
                },
                child: Card(
                  margin: const EdgeInsets.symmetric(
                      vertical: 20, horizontal: 15.0),
