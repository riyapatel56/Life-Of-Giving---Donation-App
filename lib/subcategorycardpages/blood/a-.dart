...
import 'package:life_of_giving/NGO/Blood/A-/a-1.dart';
import 'package:life_of_giving/NGO/Blood/A-/a-2.dart';
import 'package:life_of_giving/NGO/Blood/A-/a-3.dart';
import 'package:life_of_giving/NGO/Blood/A-/a-5.dart';
import 'package:life_of_giving/categorycardpages/blood.dart';

class ANegative extends StatefulWidget {
  @override
  _ANegativeState createState() => _ANegativeState();
}
...
class _ANegativeState extends State<ANegative> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'NGO\'s which are donating A- Blood',
          ...
          child: Column(
            children: [
              InkResponse(
                onTap: () {
                  Navigator.push(
                      context, MaterialPageRoute(builder: (context) => ANB1()));
                },
                child: Card(
              ...
              InkResponse(
                onTap: () {
                  Navigator.push(
                      context, MaterialPageRoute(builder: (context) => ANB2()));
                },
                child: Card(
                  margin: const EdgeInsets.symmetric(
                      vertical: 20, horizontal: 15.0),
              ...
              InkResponse(
                onTap: () {
                  Navigator.push(
                      context, MaterialPageRoute(builder: (context) => ANB3()));
                },
                child: Card(
                  margin: const EdgeInsets.symmetric(
                      vertical: 20, horizontal: 15.0),
              ...
              InkResponse(
                onTap: () {
                  Navigator.push(
                      context, MaterialPageRoute(builder: (context) => ANB4()));
                },
                child: Card(
                  margin: const EdgeInsets.symmetric(
                      vertical: 20, horizontal: 15.0),
